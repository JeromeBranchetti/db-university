...
INSERT INTO `courses`(`name`, `description`, `cfu`, `degrees_id`) VALUES('Analisi', 'il corso di analisi è un corso di matematica avanzata che parla di calcolo differenziale', 6, 1);
INSERT INTO `courses`(`name`, `description`, `cfu`, `degrees_id`) VALUES('Analisi2', 'il corso di analisi è un corso di matematica avanzata che parla di calcolo differenziale intermedio', 9, 2);
INSERT INTO `courses`(`name`, `description`, `cfu`, `degrees_id`) VALUES('Analisi3', 'il corso di analisi è un corso di matematica avanzata che parla di calcolo differenziale avanzato', 12, 3);
